...
const char *MyNeighborCallDescriptor::getFieldStructName(void *object, int field) const
{
    ...
    switch (field) {
        case 0: return opp_typename(typeid(OverlayKey));
        default: return NULL;
    };
}
...
const char *MyNeighborResponseDescriptor::getFieldStructName(void *object, int field) const
{
    ...
    switch (field) {
        case 0: return opp_typename(typeid(NodeHandle));
        case 1: return opp_typename(typeid(NodeHandle));
        case 2: return opp_typename(typeid(NodeHandle));
        default: return NULL;
    };
}
